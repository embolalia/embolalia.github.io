...
My parents saw the original Historical Documents[^21] on the air when they were kids. The tales I had heard them and others recount had always intrigued me, so I reviewed the Documents. I revisited a dark page[^22], saw past this mortal coil[^23], and met the empath[^24]. I travelled far beyond the stars[^25], and found meaning in the stories. They're real to me.[^26]

<foo style="color: black; background-color: black">Humans from the mirror universe are more sensitive to light.</foo>[^27] There's a ganglion in the human eye, discovered within my lifetime, which plays a role in the body's response to light.[^28] It effects circadian rhythms and pupil size, but might it also affect emotion? Is this where fear of the light and dark starts? Am I feeling pain, or discomfort, and is that where it's from? These ganglia <foo style="color: black; background-color: black">can't come off</foo>[^29], but my relationship to them can be changed. My visible spectrum began shifting as I crossed the galactic barrier.[^30]

It's a different world in the starlight. Or it's the same world, but I see it differently. Different things matter. Or the same things matter, but I have to prioritize and process them differently. It's just as valid, just as real, just as meaningful, but differently. There's nothing wrong or fearsome about difference. Maybe this is a path to Kityha[^31], but I am certain it means something. These aren't the only stories I'm hearing it from.
...
[^27]: [DIS 1x12](https://memory-alpha.fandom.com/wiki/Vaulting_Ambition_(episode)), "Vaulting Ambition"
[^28]: The technical term is ["intrinsically photosensitive retinal ganglion cell"](https://en.wikipedia.org/wiki/Intrinsically_photosensitive_retinal_ganglion_cell)
[^29]: [DIS 2x04](https://memory-alpha.fandom.com/wiki/An_Obol_for_Charon_(episode)), "An Obol for Charon"
[^30]: [DIS 4x10](https://memory-alpha.fandom.com/wiki/The_Galactic_Barrier_(episode)), "The Galactic Barrier"
[^31]: [LD 3x08](https://memory-alpha.fandom.com/wiki/Crisis_Point_2:_Paradoxus_(episode)), "Crisis Point 2: Paradoxus"

### Corinthians

The blind cannot lead the blind. There is still much I can't see, and much I turn a blind eye to. I have no business telling anyone else what they must do. I've heard about the pit, and I've been told to be afraid of everything that lives within.[^32] Others have claimed to know how to fix me, and in trying harmed me, so it would be wrong for me to repeat that error. And yet, something screams to me from the oldest myths and the newest science, from song and story, from my own experience and what I have heard from others.

There is a time for light, and a time for dark; a time to be blind, and a time to see.[^33] The eye that seems to be weaker is indispensable, and the parts of the eye that we think are less honorable we should treat with special honor.[^34] Therefore, let nobody judge you for a new moon celebration, or a sabbath night.[^35] Make time to gaze at the stars, without the distraction of artificial lights or the distortion of artificial lenses. Put out the fear of silence, put out the need for guidance, put out your own devices, and don't be afraid of the cold.[^36]

I cannot pretend this is easy. I fail at it regularly. It makes the [Giraffes](/giraffes) come out, and my head explodes with dark forebodings[^37]. Facing these is rather the point. The predictions may come true, and the reminders may be grim, and they may need my attention come daylight, but in the night, they do not need my fear.
...
[^32]: ["The Pit"](https://www.youtube.com/watch?v=FUvztjUS1vg), by Silversun Pickups
[^33]: Alluding to [Ecclesiastes 3:1-8](https://www.biblegateway.com/passage/?search=ecclesiastes%203:1-8)
[^34]: Alluding to [1 Corinthians 12:22-23](https://www.biblegateway.com/passage/?search=1%20Corinthians%2012%3A22-23)
[^35]: Alluding to [Colossians 2:16](https://www.biblegateway.com/passage/?search=Colossians%202%3A16)
[^36]: ["Growing Old is Getting Old](https://www.youtube.com/watch?v=9-lyt2akwiM), by Silversun Pickups
[^37]: ["Brain Damage"](https://www.youtube.com/watch?v=QFdkM40KOhE), from Pink Floyd's *The Dark Side of the Moon*

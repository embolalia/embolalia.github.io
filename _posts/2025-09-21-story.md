...
[^20]: Among other things, I drowned when I was 2 years old, and was back in the water the next day. Just keep swimming… (a reference to [*Finding Nemo*](https://www.youtube.com/watch?v=y9FGsJ3PYVw))
[^21]: Initially this said it was when I was 16, but I had misremembered the timeline


### Discovery

My parents saw the original Historical Documents[^22] on the air when they were kids. The tales I had heard them and others recount had always intrigued me, so I reviewed the Documents. I revisited a dark page[^23], saw past this mortal coil[^24], and met the empath[^25]. I traveled far beyond the stars[^26], and found meaning in the stories. They're real to me.[^27]

The implant changed who I am.[^28] For better or worse, it reprogrammed me, and I didn't choose it. But they programmed that in; I thought it was elective.[^29] There are <span id="lights">4</span> lights.[^30]
<script>
function gaslight() {
...
Humans from the mirror universe are more sensitive to light.[^31] There's a ganglion in the human eye, discovered within my lifetime, which plays a role in the body's response to light.[^32] It effects circadian rhythms and pupil size, but might it also affect emotion? Is this where fear of the light and dark starts? Am I feeling pain, or discomfort, and is that where it's from? These ganglia can't come off[^33], but my relationship to them can be changed. My visible spectrum began shifting as I crossed the galactic barrier.[^34]

It's a different world in the starlight. Or it's the same world, but I see it differently. Different things matter. Or the same things matter, but I have to prioritize and process them differently. It's just as valid, just as real, just as meaningful, but differently. There's nothing wrong or fearsome about difference. Maybe this is a path to Kityha[^35], but I am certain it means something. These aren't the only stories I'm hearing it from.
...
[^22]: Reference to [*Galaxy Quest* (1999)](https://en.wikipedia.org/wiki/Galaxy_Quest)
[^23]: [TNG 7x07](https://memory-alpha.fandom.com/wiki/Dark_Page_(episode)), "Dark Page"
[^24]: [VOY 4x12](https://memory-alpha.fandom.com/wiki/Mortal_Coil_(episode)), "Mortal Coil"
[^25]: [TOS 3x08](https://memory-alpha.fandom.com/wiki/The_Empath_(episode)), "The Empath"
[^26]: [DS9 6x13](https://memory-alpha.fandom.com/wiki/Far_Beyond_the_Stars_(episode)), "Far Beyond the Stars"
[^27]: A quote from "Far Beyond the Stars"
[^28]: [LD 3x05](https://memory-alpha.fandom.com/wiki/Reflections_(episode)), "Reflections"
[^29]: [LD 2x10](https://memory-alpha.fandom.com/wiki/First_First_Contact_(episode)), "First First Contact"
[^30]: [TNG 6x11](https://memory-alpha.fandom.com/wiki/Chain_Of_Command,_Part_II_(episode)), "Chain of Command, Part II"
[^31]: [DIS 1x12](https://memory-alpha.fandom.com/wiki/Vaulting_Ambition_(episode)), "Vaulting Ambition"
[^32]: The technical term is ["intrinsically photosensitive retinal ganglion cell"](https://en.wikipedia.org/wiki/Intrinsically_photosensitive_retinal_ganglion_cell)
[^33]: [DIS 2x04](https://memory-alpha.fandom.com/wiki/An_Obol_for_Charon_(episode)), "An Obol for Charon"
[^34]: [DIS 4x10](https://memory-alpha.fandom.com/wiki/The_Galactic_Barrier_(episode)), "The Galactic Barrier"
[^35]: [LD 3x08](https://memory-alpha.fandom.com/wiki/Crisis_Point_2:_Paradoxus_(episode)), "Crisis Point 2: Paradoxus"

### Corinthians

I kept my voice quiet about this for far too long, because I was afraid of how it sounded. It's loud and it's distorted, the longer I avoid it.[^36] Don't make my mistake. Let it out. Sing it for the world.[^37] Write it down, with footnotes to translate your tongues.[^38] Anyone who knows the red text[^39] will forgive you for it, and it will help you to forgive.

The blind cannot lead the blind. There is still much I can't see, and much I turn a blind eye to. I have no business telling anyone else what they must do. I've heard about the pit, and I've been told to be afraid of everything that lives within.[^40] Others have claimed to know how to fix me, and in trying harmed me, so it would be wrong for me to repeat that error. And yet, something screams to me from the oldest myths and the newest science, from song and story, from my own experience and what I have heard from others.
...
[^36]: ["I Will Never Settle"](https://www.youtube.com/watch?v=w3ECkPMPaso), by Metric
[^37]: ["SING"](https://www.youtube.com/watch?v=hTgnDLWeeaM), by My Chemical Romance
[^38]: hi
[^39]: Reference to the convention of printing Jesus's words in red
[^40]: ["The Pit"](https://www.youtube.com/watch?v=FUvztjUS1vg), by Silversun Pickups
[^41]: Alluding to [Ecclesiastes 3:1-8](https://www.biblegateway.com/passage/?search=ecclesiastes%203:1-8)
[^42]: Alluding to [1 Corinthians 12:22-23](https://www.biblegateway.com/passage/?search=1%20Corinthians%2012%3A22-23)
[^43]: Alluding to [Colossians 2:16](https://www.biblegateway.com/passage/?search=Colossians%202%3A16)
[^44]: ["Growing Old is Getting Old](https://www.youtube.com/watch?v=9-lyt2akwiM), by Silversun Pickups
[^45]: ["Brain Damage"](https://www.youtube.com/watch?v=QFdkM40KOhE), from Pink Floyd's *The Dark Side of the Moon*
